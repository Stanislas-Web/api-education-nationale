...
const fileContent = `// Données des comptes PROVED à créer
const provedAccountsData = ${JSON.stringify(provedAccountsData, null, 2)};

module.exports = { provedAccountsData };
`;

fs.writeFileSync('./scripts/provedAccountsData.js', fileContent);
console.log('Fichier provedAccountsData.js généré avec succès!');
